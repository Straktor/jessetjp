        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center heading">
                    <h2>Réservation</h2>
                    <p>
                        C'est ici que vous pourrez éventuellement confirmer
                        votre présence et celle de vos enfants. Vous pourrez en
                        même temps choisir votre menu et nous indiquer si vous
                        serez présent au brunch. Nous vous tiendrons au courant
                        du moment où il sera possible de confirmer le tout.
                    </p>
                    <p>
                        Pour ce faire, pouvez-vous nous laisser votre nom et
                        votre email?
                    </p>
                </div>
            </div>
            <div class="row h-flex-md">
                <div class="form-wrapper col-md-12">
                    ...
                    >
                        ...
                        <h3 class="invitation_heading">
                            Est-ce que vous allez être accompagné?
                        </h3>
                        <div class="row">
                            <div
                                id="guest-name-field"
